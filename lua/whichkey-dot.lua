...
--  c = {
 --   name = "CMake",
  ...
  l = {
    ...
    r = { "<cmd>lua require('telescope').extensions.live_grep_args.live_grep_args(require('telescope.themes').get_ivy())<cr>", "Find Text" },
    s = { "<cmd>lua require('telescope.builtin').find_files()<cr>",
